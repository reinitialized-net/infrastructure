...
}:
{
  secrets = {
    frigate = {
      description = "Runtime Docker env file: FRIGATE_CAMERA_13_37_URL, FRIGATE_CAMERA_13_37_SNAPSHOT_URL, FRIGATE_CAMERA_14_{2,3}_{USER,PASSWORD} (URL-encoded Tapo camera accounts), and FRIGATE_JWT_SECRET; never inline credentials";
