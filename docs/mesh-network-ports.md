...
| 1041 | `cliproxyapi` | TCP | 8317 | CLIProxyAPI gateway API and management UI |

Unused gap: `1033`-`1039`. Next unused port after the highest current allocation: `1042`.
...
| `ai.reinitialized.net` | `http://10.255.0.4:1041` |
