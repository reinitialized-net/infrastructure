# Reinitialized Infrastructure — Project Instructions
...
| apps1 | 204 | Application server (Hudu, DNS primary, Authentik, ownCloud OCIS) | 11 | 3 |
| apps2 | 205 | Application server (DNS secondary, UniFi) | 11 | 4 |
| apps3 | 207 | Application server (Immich, Paperless-ngx, Pelican Panel, RustDesk) | 11 | 5 |
...
- If you believe a task is going to take a long time to complete, consider using subagents. This ensures that the main agent remains responsive while the long-running task is being completed.
- If you come across something which applies to this project's instructions but isn't already documented here, please add it to this file (`GEMINI.md`). This file is meant to be a living document that captures all relevant instructions and guidelines for the project.
